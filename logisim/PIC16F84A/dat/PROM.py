...
instruction_types   = ['byte']*2 + ['mem','control'] + ['byte']*7 + ['mem','control'] +['byte']*5 + ['bit']*4 + ['literal','literal','jump','control','jump','literal','literal','control','literal','control','control','literal','literal']
...
#################################################################################
# specific sequences 
byte_type,mem_type,bit_type,litt_type,control_type,jump_type = df_PROM['type']=='byte', df_PROM['type']=='mem',df_PROM['type']=='bit', df_PROM['type']=='literal', df_PROM['type']=='control', df_PROM['type']=='jump'
